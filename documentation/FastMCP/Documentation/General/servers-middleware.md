...
> **Category:** General
> **Source:** gofastmcp.com_servers_middleware.json
...
For more complex tool rewriting scenarios, consider using [Tool Transformation](https://gofastmcp.com/patterns/tool-transformation) patterns which provide a more structured approach to creating modified tool variants.
...
1. **`context: MiddlewareContext`** \- Contains information about the current request: - `context.method` \- The MCP method name (e.g., “tools/call”)
...
[Sampling](https://gofastmcp.com/servers/sampling) [Token Verification](https://gofastmcp.com/servers/auth/verifiers)