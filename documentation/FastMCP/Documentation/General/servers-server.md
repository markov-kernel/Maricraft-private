...
> **Category:** General
> **Source:** gofastmcp.com_servers_server.json
...
Authentication provider for securing HTTP-based transports. See [Bearer Token Authentication](https://gofastmcp.com/servers/auth/bearer) for configuration options
...
[Quickstart](https://gofastmcp.com/getting-started/quickstart) [Running the Server](https://gofastmcp.com/deployment/running-server)