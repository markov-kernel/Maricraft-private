...
> **Category:** Clients
> **Source:** gofastmcp.com_clients_transports.json
...
- **Use [STDIO Transport](https://gofastmcp.com/clients/transports#stdio-transport)** when you need to run local MCP servers with full control over their environment and lifecycle
- **Use [Remote Transports](https://gofastmcp.com/clients/transports#remote-transports)** when connecting to production services or shared MCP servers running independently
- **Use [In-Memory Transport](https://gofastmcp.com/clients/transports#in-memory-transport)** for testing FastMCP servers without subprocess or network overhead
- **Use [MCP JSON Configuration](https://gofastmcp.com/clients/transports#mcp-json-configuration-transport)** when you need to connect to multiple servers defined in configuration files
...
[Overview](https://gofastmcp.com/clients/client) [Tools](https://gofastmcp.com/clients/tools)