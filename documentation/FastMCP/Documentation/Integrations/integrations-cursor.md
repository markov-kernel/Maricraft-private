...
> **Source:** gofastmcp.com_integrations_cursor.json
...
After running the command, Cursor will open automatically and prompt you to install the server. The command will be `uv`, which is expected as this is a Python STDIO server. Click “Install” to confirm:![Cursor install prompt](https://mintlify.s3.us-west-1.amazonaws.com/fastmcp/integrations/cursor-install-mcp.png)
...
> 🎲 Here are your dice rolls: 4, 6, 4You rolled 3 dice with a total of 14! The 6 was a nice high roll there!

The AI assistant can now access all the tools, resources, and prompts you’ve defined in your FastMCP server.

[Claude Desktop](https://gofastmcp.com/integrations/claude-desktop) [Eunomia Auth](https://gofastmcp.com/integrations/eunomia-authorization)
