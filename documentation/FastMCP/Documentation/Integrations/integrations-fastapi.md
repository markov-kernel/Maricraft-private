...
> **Source:** gofastmcp.com_integrations_fastapi.json
...
1. **[Generate an MCP server FROM your FastAPI app](https://gofastmcp.com/integrations/fastapi#generating-an-mcp-server)** \- Convert existing API endpoints into MCP tools
2. **[Mount an MCP server INTO your FastAPI app](https://gofastmcp.com/integrations/fastapi#mounting-an-mcp-server)** \- Add MCP functionality to your web application
...
[Eunomia Auth](https://gofastmcp.com/integrations/eunomia-authorization) [Gemini SDK](https://gofastmcp.com/integrations/gemini)