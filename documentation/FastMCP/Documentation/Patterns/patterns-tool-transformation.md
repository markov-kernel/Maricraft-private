...
> **Category:** Patterns
> **Source:** gofastmcp.com_patterns_tool-transformation.json
...
dictionary of tool properties.See the [MCPConfigTransport](https://gofastmcp.com/clients/transports#tool-transformation-with-fastmcp-and-mcpconfig) documentation for more details.
...
[Starlette / ASGI](https://gofastmcp.com/integrations/starlette) [Decorating Methods](https://gofastmcp.com/patterns/decorating-methods)