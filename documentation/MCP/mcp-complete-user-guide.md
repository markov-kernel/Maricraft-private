# Model Context Protocol - Complete Documentation

*A comprehensive guide to understanding and implementing MCP*

## Table of Contents

1. **[Getting Started](#mcp-getting-started)** - Entry point for newcomers - what MCP is and why it matters
   *Target audience: Newcomers*

2. **[Examples And Ecosystem](#mcp-examples-and-ecosystem)** - Discover available clients, servers, and ecosystem
   *Target audience: Integrators*

3. **[Quickstart User](#mcp-quickstart-user)** - Connect Claude Desktop to local MCP servers
   *Target audience: End-Users*

4. **[Architecture And Concepts](#mcp-architecture-and-concepts)** - Deep dive into MCP architecture, concepts, and data layer protocol
   *Target audience: Developers*

5. **[Quickstart Server](#mcp-quickstart-server)** - Build MCP servers - multi-language tutorial
   *Target audience: Developers*

6. **[Quickstart Client](#mcp-quickstart-client)** - Build MCP clients - multi-language tutorial
   *Target audience: Developers*

7. **[Remote Integration](#mcp-remote-integration)** - Connect to remote MCP servers and build remote integrations
   *Target audience: Integrators*

8. **[Sdks And Tools](#mcp-sdks-and-tools)** - SDKs, development tools, and inspector guide
   *Target audience: Developers*

9. **[Community And Governance](#mcp-community-and-governance)** - Community participation, governance, and contribution guidelines
...
**Purpose:** Entry point for newcomers - what MCP is and why it matters
**Target Audience:** Newcomers
...
================================================================================
# 2. Examples And Ecosystem
================================================================================

**Purpose:** Discover available clients, servers, and ecosystem
**Target Audience:** Integrators
...
**Purpose:** Connect Claude Desktop to local MCP servers
**Target Audience:** End-Users
...
**Purpose:** Deep dive into MCP architecture, concepts, and data layer protocol
**Target Audience:** Developers
...
**Purpose:** Build MCP servers - multi-language tutorial
**Target Audience:** Developers
...
**Purpose:** Build MCP clients - multi-language tutorial
**Target Audience:** Developers
...
**Purpose:** Connect to remote MCP servers and build remote integrations
**Target Audience:** Integrators
...
**Purpose:** SDKs, development tools, and inspector guide
**Target Audience:** Developers
...
**Purpose:** Community participation, governance, and contribution guidelines
**Target Audience:** Contributors
...
This documentation was automatically generated by merging user-focused MCP documentation files.
Each section represents a different aspect of the Model Context Protocol ecosystem.

**Excluded from this merge:**
- `mcp-specification.md` - Available as separate technical reference

For the complete technical specification, please refer to the separate specification document.

Generated from 9 source files.
