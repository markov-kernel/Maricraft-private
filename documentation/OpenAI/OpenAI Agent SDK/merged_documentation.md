...
Welcome to the official documentation for the OpenAI Agents SDK.
...
### Concepts
  ...
  - [Configuring the SDK](./concepts/config.md)
  - [Context management](./concepts/context.md)
  - [Guardrails](./concepts/guardrails.md)
  - [Handoffs](./concepts/handoffs.md)
  - [Using any model via LiteLLM](./concepts/litellm.md)
  - [Model context protocol (MCP)](./concepts/mcp.md)
  - [Models](./concepts/models.md)
  - [Orchestrating multiple agents](./concepts/multi-agent.md)
  - [OpenAI Agents SDK](./concepts/openai-agents-sdk.md)
  - [Pipelines and workflows](./concepts/pipeline.md)
  - [Release process/changelog](./concepts/release.md)
  - [REPL utility](./concepts/repl.md)
  - [Results](./concepts/results.md)
  - [Running agents](./concepts/running-agents.md)
  - [Sessions](./concepts/sessions.md)
  - [Streaming](./concepts/streaming.md)
  - [Tools](./concepts/tools.md)
  - [Tracing](./concepts/tracing.md)
  - [Agent Visualization](./concepts/visualization.md)
...
### Reference
  ...
  ### Core
    ...
    - [Agent output](./reference/core/agent-output.md)
    - [Agents](./reference/core/agent.md)
    - [Exceptions](./reference/core/exceptions.md)
    - [Function schema](./reference/core/function-schema.md)
    - [Guardrails](./reference/core/guardrail.md)
    - [Handoffs](./reference/core/handoffs.md)
    - [Model interface](./reference/core/interface.md)
    - [Items](./reference/core/items.md)
    - [Lifecycle](./reference/core/lifecycle.md)
    - [Memory](./reference/core/memory.md)
    - [Model settings](./reference/core/model-settings.md)
    - [OpenAI Chat Completions model](./reference/core/openai-chatcompletions.md)
    - [OpenAI Responses model](./reference/core/openai-responses.md)
    - [Agents module](./reference/core/ref.md)
    - [repl](./reference/core/repl.md)
    - [Results](./reference/core/result.md)
    - [Run context](./reference/core/run-context.md)
    - [Runner](./reference/core/run.md)
    - [MCP Servers](./reference/core/server.md)
    - [Streaming events](./reference/core/stream-events.md)
    - [OpenAI Agents SDK](./reference/core/tool-context.md.md)
    - [Tools](./reference/core/tool.md)
    - [Usage](./reference/core/usage.md)
    - [MCP Util](./reference/core/util.md)

  ### Extensions

    - [Handoff filters](./reference/extensions/handoff-filters.md)
    - [Handoff prompt](./reference/extensions/handoff-prompt.md)
    - [LiteLLM Models](./reference/extensions/litellm.md)

  ### Realtime

    - [RealtimeAgent](./reference/realtime/agent.md)
    - [Realtime Configuration](./reference/realtime/config.md)
    - [Realtime Events](./reference/realtime/events.md)
    - [RealtimeRunner](./reference/realtime/runner.md)
    - [RealtimeSession](./reference/realtime/session.md)

  ### Tracing

    - [Creating traces/spans](./reference/tracing/create.md)
    - [Processor interface](./reference/tracing/processor-interface.md)
    - [Processors](./reference/tracing/processors.md)
    - [Scope](./reference/tracing/scope.md)
    - [Setup](./reference/tracing/setup.md)
    - [Span data](./reference/tracing/span-data.md)
    - [Spans](./reference/tracing/spans.md)
    - [Traces](./reference/tracing/traces.md)
    - [Tracing module](./reference/tracing/tracing.md)
    - [Util](./reference/tracing/util.md)

  ### Voice

    - [Events](./reference/voice/events.md)
    - [Exceptions](./reference/voice/exceptions.md)
    - [Input](./reference/voice/input.md)
    - [Model](./reference/voice/model.md)
    - [OpenAIVoiceModelProvider](./reference/voice/openai-provider.md)
    - [OpenAI STT](./reference/voice/openai-stt.md)
    - [OpenAI TTS](./reference/voice/openai-tts.md)
    - [Pipeline Config](./reference/voice/pipeline-config.md)
    - [Pipeline](./reference/voice/pipeline.md)
    - [Result](./reference/voice/result.md)
    - [Utils](./reference/voice/utils.md)
    - [Workflow](./reference/voice/workflow.md)
...
agent = Agent[UserContext](https://openai.github.io/openai-agents-python/
    ...,
)
...
Sometimes, you want to observe the lifecycle of an agent. For example, you may want to log events, or pre-fetch data when certain events occur. You can hook into the agent lifecycle with the `hooks` property. Subclass the [`AgentHooks`](https://openai.github.io/openai-agents-python/ref/lifecycle/#agents.lifecycle.AgentHooks "AgentHooks            module-attribute   ") class, and override the methods you're interested in.
...
async def main():
    ...
    agent = Agent[UserInfo](https://openai.github.io/openai-agents-python/
        name="Assistant",
...
Fundamental concepts and architecture of the OpenAI Agents SDK.


## Table of Contents

- [Agents](./agents.md)
- [Configuring the SDK](./config.md)
- [Context management](./context.md)
- [Guardrails](./guardrails.md)
- [Handoffs](./handoffs.md)
- [Using any model via LiteLLM](./litellm.md)
- [Model context protocol (MCP)](./mcp.md)
- [Models](./models.md)
- [Orchestrating multiple agents](./multi-agent.md)
- [OpenAI Agents SDK](./openai-agents-sdk.md)
- [Pipelines and workflows](./pipeline.md)
...
# File: concepts/litellm.md

---
title: Using any model via LiteLLM
...
When you want to further configure the model used for an agent, you can pass [`ModelSettings`](https://openai.github.io/openai-agents-python/ref/model_settings/#agents.model_settings.ModelSettings "ModelSettings"), which provides optional model configuration parameters such as temperature.
...
# File: concepts/openai-agents-sdk.md
...
In this version, [`MCPServer.list_tools()`](https://openai.github.io/openai-agents-python/ref/mcp/server/#agents.mcp.server.MCPServer "MCPServer") has two new params: `run_context` and `agent`. You'll need to add these params to any classes that subclass `MCPServer`.

---


# File: concepts/repl.md
...
# File: concepts/running-agents.md
...
You can implement your own session memory by creating a class that follows the [`Session`](https://openai.github.io/openai-agents-python/ref/memory/#agents.memory.Session "Session") protocol:
...
- [`Session`](https://openai.github.io/openai-agents-python/ref/memory/#agents.memory.Session "Session") \- Protocol interface
- [`SQLiteSession`](https://openai.github.io/openai-agents-python/ref/memory/#agents.memory.SQLiteSession "SQLiteSession") \- SQLite implementation
...
- `on_invoke_tool`, which is an async function that receives a \[ `ToolContext`\]\[agents.tool\_context.ToolContext\] and the arguments as a JSON string, and must return the tool output as a string.
...
- **Traces** represent a single end-to-end operation of a "workflow". They're composed of Spans. Traces have the following properties:
  ...
  - `trace_id`: A unique ID for the trace. Automatically generated if you don't pass one. Must have the format `trace_`.
...
# File: concepts/visualization.md
...
- **[customer\_service](https://github.com/openai/openai-agents-python/tree/main/examples/customer_service)** and **[research\_bot](https://github.com/openai/openai-agents-python/tree/main/examples/research_bot):**
...
RealtimeAgent works similarly to the regular Agent class with some key differences. For full API details, see the [`RealtimeAgent`](https://openai.github.io/openai-agents-python/ref/realtime/agent/#agents.realtime.agent.RealtimeAgent) API reference.
...
- **audio\_end**: Agent finished speaking
- **audio\_interrupted**: User interrupted the agent
- **tool\_start/tool\_end**: Tool execution lifecycle
- **handoff**: Agent handoff occurred
- **error**: Error occurred during processing

For complete event details, see [`RealtimeSessionEvent`](https://openai.github.io/openai-agents-python/ref/realtime/events/#agents.realtime.events.RealtimeSessionEvent).
...
Send audio to the session using [`session.send_audio(audio_bytes)`](https://openai.github.io/openai-agents-python/ref/realtime/session/#agents.realtime.session.RealtimeSession.send_audio "send_audio            async   ") or send text using [`session.send_message()`](https://openai.github.io/openai-agents-python/ref/realtime/session/#agents.realtime.session.RealtimeSession.send_message "send_message            async   ").
...
- [Learn more about realtime agents](https://openai.github.io/openai-agents-python/realtime/guide/)
