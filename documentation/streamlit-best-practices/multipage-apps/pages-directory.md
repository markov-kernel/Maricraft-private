...
- Pages share the same [st.session\_state](https://docs.streamlit.io/develop/concepts/architecture/session-state):
...
You now have a solid understanding of multipage apps. You've learned how to structure apps, define pages, and navigate between pages in the user interface. It's time to [create your first multipage app](https://docs.streamlit.io/get-started/tutorials/create-a-multipage-app)! 🥳