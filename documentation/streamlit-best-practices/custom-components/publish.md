...
For [static Streamlit Components](https://docs.streamlit.io/develop/concepts/custom-components/intro#create-a-static-component), publishing a Python package to PyPI follows the same steps as the
...
![](https://docs.streamlit.io/images/component-tag.gif)
