...
[Fullscreen _open\_in\_new_](https://doc-dataframe-basic.streamlit.app/?utm_medium=oembed)
...
- **Column sorting**: To sort columns, select their headers, or select " **Sort ascending**" or " **Sort descending**" from the header menu ( _more\_vert_).
...
- **Fullscreen view**: To enlarge dataframes to fullscreen, select the fullscreen icon ( _fullscreen_) in the toolbar.
- **Search**: To search through the data, select the search icon ( _search_) in the toolbar or use hotkeys ( `⌘+F` or `Ctrl+F`).
- **Download**: To download the data as a CSV file, select the download icon ( _download_) in the toolbar.
...
\[Unlisted\] Docs: Dataframe UI in Streamlit - YouTube

[Photo image of Streamlit](https://www.youtube.com/channel/UC3LD42rjj-Owtxsa6PwGU5Q?embeds_referring_euri=https%3A%2F%2Fdocs.streamlit.io%2F)

Streamlit

25.5K subscribers

[\[Unlisted\] Docs: Dataframe UI in Streamlit](https://www.youtube.com/watch?list=TLGGei6twpCz74cwNjA4MjAyNQ&v=nauAnULRG1c)
...
[Previous (SHIFT+p)](https://www.youtube.com/watch?list=TLGGei6twpCz74cwNjA4MjAyNQ&v=nauAnULRG1c "Previous (SHIFT+p)")[Next (SHIFT+n)](https://www.youtube.com/watch?list=TLGGei6twpCz74cwNjA4MjAyNQ&v=nauAnULRG1c "Next (SHIFT+n)")
...
|  | command | rating | is\_widget |
| --- | --- | --- | --- |
| 0 | st.selectbox | 4 | true |
| 1 | st.balloons | 5 | false |
| 2 | st.time\_input | 3 | true |

Your favorite command is **st.balloons** 🎈

[Built with Streamlit 🎈](https://streamlit.io/)

[Fullscreen _open\_in\_new_](https://doc-data-editor.streamlit.app/?utm_medium=oembed)
...
\[Unlisted\] Docs: Data editor UI in Streamlit - YouTube
...
[\[Unlisted\] Docs: Data editor UI in Streamlit](https://www.youtube.com/watch?list=TLGGKK4Dnf1gepcwNjA4MjAyNQ&v=6tah69LkfxE)
...
[Previous (SHIFT+p)](https://www.youtube.com/watch?list=TLGGKK4Dnf1gepcwNjA4MjAyNQ&v=6tah69LkfxE "Previous (SHIFT+p)")[Next (SHIFT+n)](https://www.youtube.com/watch?list=TLGGKK4Dnf1gepcwNjA4MjAyNQ&v=6tah69LkfxE "Next (SHIFT+n)")
...
[Fullscreen _open\_in\_new_](https://doc-data-editor-clipboard.streamlit.app/?utm_medium=oembed)
...
[Fullscreen _open\_in\_new_](https://doc-data-editor-changed.streamlit.app/?utm_medium=oembed)
...
[Fullscreen _open\_in\_new_](https://doc-column-config-empty.streamlit.app/?utm_medium=oembed)
...
- While Streamlit's data editing capabilities offer a lot of functionality, editing is enabled for a limited set of column types ( [TextColumn](https://docs.streamlit.io/develop/api-reference/data/st.column_config/st.column_config.textcolumn), [NumberColumn](https://docs.streamlit.io/develop/api-reference/data/st.column_config/st.column_config.numbercolumn), [LinkColumn](https://docs.streamlit.io/develop/api-reference/data/st.column_config/st.column_config.linkcolumn), [CheckboxColumn](https://docs.streamlit.io/develop/api-reference/data/st.column_config/st.column_config.checkboxcolumn), [SelectboxColumn](https://docs.streamlit.io/develop/api-reference/data/st.column_config/st.column_config.selectboxcolumn), [DateColumn](https://docs.streamlit.io/develop/api-reference/data/st.column_config/st.column_config.datecolumn), [TimeColumn](https://docs.streamlit.io/develop/api-reference/data/st.column_config/st.column_config.timecolumn), and [DatetimeColumn](https://docs.streamlit.io/develop/api-reference/data/st.column_config/st.column_config.datetimecolumn)). We are actively working on supporting editing for other column types as well, such as images, lists, and charts.
