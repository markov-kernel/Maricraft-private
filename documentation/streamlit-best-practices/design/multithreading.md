...
![Each user session uses script threads to communicate between the user's front end and the Streamlit server.](https://docs.streamlit.io/images/concepts/Streamlit-threading.svg)
...
[Fullscreen _open\_in\_new_](https://doc-multithreading-no-st-commands-batched.streamlit.app/?utm_medium=oembed)
...
[Fullscreen _open\_in\_new_](https://doc-multithreading-no-st-commands-iterative.streamlit.app/?utm_medium=oembed)
...
[Fullscreen _open\_in\_new_](https://doc-multithreading-expose-context.streamlit.app/?utm_medium=oembed)