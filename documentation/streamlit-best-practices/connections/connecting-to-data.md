...
**Anything you can do with Python, including data connections, will generally work in Streamlit**. Streamlit's [tutorials](https://docs.streamlit.io/develop/tutorials/databases) are a great starting place for many data sources. However:
...
Introducing st.connection for connecting to SQL database in 4 lines - YouTube
...
[Introducing st.connection for connecting to SQL database in 4 lines](https://www.youtube.com/watch?list=TLGGAxN0dA-LUZ8wNjA4MjAyNQ&v=xQwDfW7UHMo)
...
[Previous (SHIFT+p)](https://www.youtube.com/watch?list=TLGGAxN0dA-LUZ8wNjA4MjAyNQ&v=xQwDfW7UHMo "Previous (SHIFT+p)")
...
[Fullscreen](https://experimental-connection.streamlit.app/?utm_medium=oembed)
...
[Fullscreen _open\_in\_new_](https://experimental-connection.streamlit.app/SQL/?utm_medium=oembed)
...
[Fullscreen _open\_in\_new_](https://experimental-connection.streamlit.app/Build_your_own/?utm_medium=oembed)
